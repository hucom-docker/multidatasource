...
public class DateUtil {
     ...
     * 
     */
    public static final String DATE_NULL_UNDERLINE_MS_FMT = "yyyyMMddHHmmssSSS";

    /**
     * 年月日时分秒(无下划线) yyyyMMddHHmmss
     */
    public static final String DATE_NULL_UNDERLINE_SEC_LONG = "yyyyMMddHHmmss";

    /**
     * 完整时间 yyyy-MM-dd HH:mm:ss
     */
    public static final String DATE_24HOUR_FMT = "yyyy-MM-dd HH:mm:ss";
     ...
     * 年月日(无下划线) yyyyMMdd
     */
    public static final String DATE_NULL_UNDERLINE_SHORT_FMT = "yyyyMMdd";

    /**
     * 时分秒(无下划线) HHmmss
     */
    public static final String HMS_FMT = "HHmmss";
    ...
    public static String getMsgId() {
        ...
        String msgId = getCurrentDate(DATE_NULL_UNDERLINE_SEC_LONG) + "-" + String.valueOf(ran);
        return msgId;
    }
